...
$sql1="CREATE TABLE passbook".$acc."
...
$sql="insert into customer values('$acc','$name','$gender','$dob','$nominee','$type','$address','$mobile',
    '$email','$password','$branch','$ifsc','','ACTIVE')";
mysqli_query($con,$sql) or die("Email already exists!");
mysqli_query($con,$sql1) or die(mysqli_error($con));
$sql4="insert into passbook".$acc." values('','$date','$name','$branch','$ifsc','$credit','0','$credit','Account Open')";
