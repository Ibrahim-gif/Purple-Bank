        ...
        <div class="displaystaff_content">
           ...
           <?php include 'staff_navbar.php'?>
            <div class="customer_top_nav">
             <div class="text" style="color: purple">Welcome <?php echo $_SESSION['name1']?></div>
            </div>

            <div class="customer_body">
             <div class="content1">
                <p><span class="heading1">Name: </span><?php echo $name;?></p>
            <p><span class="heading1">Department: </span><?php echo $department;?></p>
            <p><span class="heading1">Email: </span><?php echo $email;?></p>
            </div>
             <div class="content2">
            <p><span class="heading1">DOJ: </span><?php echo $doj;?></p>
